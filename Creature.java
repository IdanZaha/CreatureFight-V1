...
public class Creature extends Actor
{
     ...
     */
    /**
     * the HealthBar method is the method used for calling the HealthBar.
     * 
     ...
     */
    /**
     * the getPlayerOwner method is used for calling the int used for playerOwnership.
     * 
     * @params - there is one parameter.
     * @returns - there are no returns.
     */
    public int getPlayerOwner()
    {
        return (int)playerOwnership;
    }
}
